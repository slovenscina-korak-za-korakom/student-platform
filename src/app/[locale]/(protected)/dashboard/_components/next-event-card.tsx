...
const NextEventCard = ({event, locale}: NextEventCardProps) => {
  ...
  return (
    <>
      <Card
        className="w-full bg-white dark:bg-[#1a1a1a] rounded-2xl border border-border/40 dark:border-white/10 shadow-[0_1px_3px_rgba(0,0,0,0.05),0_1px_2px_rgba(0,0,0,0.1)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.08),0_2px_6px_rgba(0,0,0,0.12)] transition-all duration-300 overflow-hidden">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            >
              {isLanguageClub
                ...
                }[event.sessionType ?? ""] ?? event.sessionType ?? event.type)}
            </Badge>
            {event.level && (
          ...
          {isRegular ? (
            ...
            <>
              <AlertDialog>
                ...
                <AlertDialogContent
                  className="bg-white dark:bg-[#1a1a1a] border-red-500 dark:border-red-500/30 border-2 rounded-2xl">
                  <AlertDialogHeader>
