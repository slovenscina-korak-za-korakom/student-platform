...
export default function NavBar({locale}) {
  ...
  return (
    <header
      className="fixed bg-background/90 dark:bg-[#131014]/90 py-2 lg:py-3 border-b border-border/50 dark:border-border/30 inset-x-0 top-0 z-50">
      <div
        aria-label="Global"
        ...
        <div className="flex items-center px-6 lg:px-0 flex-1 sm:items-stretch justify-between">
          <div className="flex items-center">
            <Link
              href="/"
              type="button"
              className="block w-auto focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-foreground-lighter focus-visible:ring-offset-4 focus-visible:ring-offset-background-alternative focus-visible:rounded-sm"
            >
